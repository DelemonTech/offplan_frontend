  ...
  return (
    <section className="py-10 bg-gradient-to-br from-slate-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className={`absolute top-20 w-72 h-72 bg-purple-200 rounded-full blur-3xl ${
          i18n.language === 'fa' || i18n.language === 'ar' ? 'right-20' : 'left-20'
        }`}></div>
        <div className={`absolute bottom-20 w-96 h-96 bg-pink-200 rounded-full blur-3xl ${
          i18n.language === 'fa' || i18n.language === 'ar' ? 'left-20' : 'right-20'
        }`}></div>
            ...
            <div className="lg:col-span-4 flex">
              <div className="bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600 rounded-3xl p-6 shadow-2xl border border-purple-400/20 w-full flex flex-col">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 flex-grow flex flex-col">
                  ...
                  >
                    <Send size={18} className={i18n.language === 'fa' || i18n.language === 'ar' ? 'ml-2' : 'mr-2'} />
                    {t('Submit Request')}
                  </Button>
                </form>
              </div>
