...
const resources = {
  ...
  fa: {
    translation: {
      ...
      "Email address": "آدرس ایمیل",
      "Submit Request": "ارسال درخواست",
      "About OFFPLAN.MARKET": "درباره OFFPLAN.MARKET",
      "Dubai's Premier Off-Plan Property Platform": "برترین پلتفرم املاک پیش‌فروش در دبی",
      "Connecting investors with the best off-plan opportunities through verified agents and exclusive developer partnerships": "اتصال سرمایه‌گذاران به بهترین فرصت‌های پیش‌فروش از طریق مشاوران معتبر و همکاری انحصاری با توسعه‌دهندگان",
      "Connect with Our Team": "ارتباط با تیم ما",
      "Our Mission": "ماموریت ما",
      "At OFFPLAN.MARKET, we're revolutionizing the way people discover and invest in Dubai's off-plan properties. Our mission is to provide a transparent, efficient, and trustworthy platform that connects investors with the most promising real estate opportunities.": "در OFFPLAN.MARKET، ما در حال متحول کردن شیوه کشف و سرمایه‌گذاری در املاک پیش‌فروش دبی هستیم. ماموریت ما ایجاد یک پلتفرم شفاف، کارآمد و قابل اعتماد است که سرمایه‌گذاران را به بهترین فرصت‌های املاک متصل می‌کند.",
      "We believe that everyone deserves access to premium off-plan investments, regardless of their location or experience level. By partnering with Dubai's top developers and verified real estate agents, we ensure that our clients receive exclusive access to the most lucrative investment opportunities.": "ما معتقدیم همه باید بدون توجه به موقعیت مکانی یا سطح تجربه، به سرمایه‌گذاری‌های ممتاز پیش‌فروش دسترسی داشته باشند. با همکاری با توسعه‌دهندگان برتر دبی و مشاوران معتبر املاک، تضمین می‌کنیم مشتریان ما به بهترین فرصت‌های سرمایه‌گذاری انحصاری دسترسی داشته باشند.",
      "Our platform combines cutting-edge technology with deep market expertise to deliver personalized property recommendations, real-time market insights, and seamless transaction experiences.": "پلتفرم ما فناوری پیشرفته را با تخصص عمیق بازار ترکیب می‌کند تا پیشنهادات شخصی‌سازی‌شده املاک، بینش‌های لحظه‌ای بازار و تجربه‌های معاملاتی بدون مشکل ارائه دهد.",
      "Why Choose OFFPLAN.MARKET?": "چرا OFFPLAN.MARKET را انتخاب کنید؟",
      "Verified Agents & Developers": "مشاوران و توسعه‌دهندگان معتبر",
      "Real-time Market Data": "داده‌های لحظه‌ای بازار",
      "AI-Powered Matching": "تطبیق هوشمند با هوش مصنوعی",
      "Global Investor Support": "پشتیبانی سرمایه‌گذاران جهانی",
      "Our Values": "ارزش‌های ما",
      "Transparency & Trust": "شفافیت و اعتماد",
      "Excellence in Service": "برتری در خدمات",
      "Client-Centric Approach": "رویکرد مشتری‌محور",
      "Innovation & Growth": "نوآوری و رشد",
      "OFFPLAN.MARKET by the Numbers": "OFFPLAN.MARKET به زبان اعداد",
      "Our platform has transformed the way investors discover and invest in Dubai's off-plan market": "پلتفرم ما شیوه کشف و سرمایه‌گذاری در بازار پیش‌فروش دبی را متحول کرده است",
      "Properties Listed": "املاک ثبت‌شده",
      "Verified Agents": "مشاوران تأییدشده",
      "Developer Partners": "شرکای توسعه‌دهنده",
      "Happy Investors": "سرمایه‌گذاران خوشحال",
      "What Makes Us Different": "چه چیزی ما را متمایز می‌کند",
      "We combine technology, expertise, and personalized service to deliver exceptional results": "ما فناوری، تخصص و خدمات شخصی‌سازی‌شده را ترکیب می‌کنیم تا نتایجی استثنایی ارائه دهیم",
      "Verified Partners": "شرکای تأییدشده",
      "All our agents and developers are thoroughly vetted and RERA-registered for your security and peace of mind.": "تمام مشاوران و توسعه‌دهندگان ما کاملاً بررسی و در RERA ثبت شده‌اند تا امنیت و آرامش خاطر شما تضمین شود.",
      "Real-Time Data": "داده‌های لحظه‌ای",
      "Access up-to-the-minute property information, pricing, and availability directly from developer systems.": "به جدیدترین اطلاعات املاک، قیمت‌گذاری و موجودی به‌طور مستقیم از سیستم‌های توسعه‌دهندگان دسترسی پیدا کنید.",
      "Smart Matching": "تطبیق هوشمند",
      "Our AI-powered system matches you with properties that perfectly fit your investment criteria and budget.": "سیستم مجهز به هوش مصنوعی ما شما را با املاکی تطبیق می‌دهد که کاملاً با معیارها و بودجه سرمایه‌گذاری شما مطابقت دارند.",
      "Global Reach": "دسترسی جهانی",
      "Serve international investors with multilingual support and comprehensive market insights.": "به سرمایه‌گذاران بین‌المللی با پشتیبانی چندزبانه و بینش جامع بازار خدمات ارائه می‌دهیم.",
      "End-to-End Support": "پشتیبانی کامل",
      "Complete assistance from property discovery to handover, with ongoing investment guidance.": "کمک کامل از کشف ملک تا تحویل، همراه با راهنمایی مداوم سرمایه‌گذاری.",
      "Exclusive Deals": "معاملات انحصاری",
      "Access to off-plan opportunities before they hit the general market, with special pricing for our clients.": "دسترسی به فرصت‌های پیش‌فروش قبل از ورود به بازار عمومی، با قیمت‌گذاری ویژه برای مشتریان ما.",
      "Our Expert Team": "تیم متخصص ما",
      "Meet the professionals behind OFFPLAN.MARKET's success": "با متخصصانی که پشت موفقیت OFFPLAN.MARKET هستند آشنا شوید",
      "Real Estate Experts": "متخصصان املاک",
      "Seasoned professionals with deep knowledge of Dubai's property market and investment strategies.": "حرفه‌ای‌های باتجربه با دانش عمیق از بازار املاک دبی و استراتژی‌های سرمایه‌گذاری.",
      "Property Consultants": "مشاوران املاک",
      "Dedicated consultants providing personalized guidance and market insights to help you make informed decisions.": "مشاوران متخصص که راهنمایی‌های شخصی‌سازی‌شده و بینش‌های بازار ارائه می‌دهند تا به شما در تصمیم‌گیری‌های آگاهانه کمک کنند.",
      "Customer Success": "موفقیت مشتریان",
      "Our support team ensures smooth transactions and provides ongoing assistance throughout your investment journey.": "تیم پشتیبانی ما معاملات روان را تضمین کرده و در کل مسیر سرمایه‌گذاری کمک مداوم ارائه می‌دهد.",
      "Ready to Get Started?": "آماده شروع هستید؟",
      "Join thousands of successful investors who trust OFFPLAN.MARKET for their Dubai real estate journey. Our expert team is ready to guide you to your perfect investment.": "به هزاران سرمایه‌گذار موفقی بپیوندید که به OFFPLAN.MARKET برای مسیر املاک خود در دبی اعتماد کرده‌اند. تیم متخصص ما آماده است تا شما را به سمت سرمایه‌گذاری ایده‌آل‌تان راهنمایی کند.",
      "Contact Our Team Today": "امروز با تیم ما تماس بگیرید",

      "Contact Us": "تماس با ما",
  "Ready to start your Dubai property investment journey?": "آماده شروع سفر سرمایه گذاری ملکی خود در دبی هستید؟",
  "Our expert team is here to help you find the perfect off-plan property and guide you through every step": "تیم متخصص ما اینجاست تا به شما کمک کند ملک مناسب پیش‌خریدی را پیدا کنید و در هر مرحله شما را راهنمایی کند",
  "Connect with Our Experts": "با کارشناسان ما در ارتباط باشید",
  "Get In Touch": "با ما در تماس باشید",
  "Dubai's Premier Property Platform": "برترین پلتفرم ملکی دبی",
  "Dubai, United Arab Emirates": "دبی، امارات متحده عربی",
  "Daily 9:00 AM – 9:00 PM (GST)": "روزانه ۹ صبح تا ۹ شب (GST)",
  "\"Our team will get back to you within 2 hours during business hours.\"": "«تیم ما در ساعات کاری ظرف دو ساعت با شما تماس خواهد گرفت.»",
  "Quick Contact Options": "گزینه‌های سریع تماس",
  "WhatsApp Chat": "چت واتس‌اپ",
  "Call Now": "همین حالا تماس بگیرید",
  "Send Email": "ارسال ایمیل",
  "How We Can Help": "چطور می‌توانیم کمک کنیم",
  "Property Investment": "سرمایه‌گذاری ملکی",
  "Expert guidance on off-plan investments": "راهنمایی تخصصی در سرمایه‌گذاری‌های پیش‌خریدی",
  "Agent Matching": "ارتباط با مشاوران",
  "Connect with verified real estate agents": "ارتباط با مشاوران املاک تایید شده",
  "Market Insights": "بینش‌های بازار",
  "Latest Dubai real estate market trends": "آخرین روندهای بازار املاک دبی",
  "Send Us a Message": "برای ما پیامی بفرستید",
  "Your name": "نام شما",
  "Mobile number": "شماره موبایل",
  "Email address": "آدرس ایمیل",
  "Your message": "پیام شما",
  "Your inquiry message": "پیام درخواست شما",
  "I agree to receive updates about new properties and market insights": "موافقت می‌کنم که به‌روزرسانی‌ها درباره املاک جدید و بینش‌های بازار را دریافت کنم",
  "Sending...": "در حال ارسال...",
  "Message Sent!": "پیام ارسال شد!",
  "Send Message": "ارسال پیام",
  "Ready to Invest?": "آماده سرمایه‌گذاری هستید؟",
  "Connect with our expert agents for personalized guidance and exclusive property opportunities in Dubai's thriving real estate market.": "با مشاوران متخصص ما برای دریافت راهنمایی شخصی‌سازی شده و فرصت‌های اختصاصی در بازار پررونق املاک دبی در ارتباط باشید.",
  "Contact Our Agents Now": "همین حالا با مشاوران ما تماس بگیرید",
  ...
  ar: {
    translation: {
      ...
      "About OFFPLAN.MARKET": "حول OFFPLAN.MARKET",
      "Dubai's Premier Off-Plan Property Platform": "المنصة الرائدة للعقارات تحت الإنشاء في دبي",
      "Connecting investors with the best off-plan opportunities through verified agents and exclusive developer partnerships": "ربط المستثمرين بأفضل الفرص من خلال وكلاء معتمدين وشراكات حصرية مع المطورين",
      "Connect with Our Team": "تواصل مع فريقنا",
      "Our Mission": "مهمتنا",
      "At OFFPLAN.MARKET, we're revolutionizing the way people discover and invest in Dubai's off-plan properties. Our mission is to provide a transparent, efficient, and trustworthy platform that connects investors with the most promising real estate opportunities.": "في OFFPLAN.MARKET، نحن نحدث ثورة في طريقة اكتشاف الناس للعقارات تحت الإنشاء في دبي. مهمتنا هي توفير منصة شفافة وفعالة وموثوقة تربط المستثمرين بأفضل فرص العقارات.",
      "We believe that everyone deserves access to premium off-plan investments, regardless of their location or experience level. By partnering with Dubai's top developers and verified real estate agents, we ensure that our clients receive exclusive access to the most lucrative investment opportunities.": "نحن نؤمن بأن للجميع الحق في الوصول إلى استثمارات عقارية متميزة، بغض النظر عن موقعهم أو مستوى خبرتهم. من خلال شراكاتنا مع كبار المطورين في دبي والوكلاء العقاريين المعتمدين، نضمن لعملائنا الوصول الحصري إلى أكثر الفرص الاستثمارية ربحية.",
      "Our platform combines cutting-edge technology with deep market expertise to deliver personalized property recommendations, real-time market insights, and seamless transaction experiences.": "منصتنا تجمع بين التكنولوجيا الحديثة والخبرة العميقة في السوق لتقديم توصيات عقارية مخصصة، ورؤى فورية عن السوق، وتجارب معاملات سلسة.",
      "Why Choose OFFPLAN.MARKET?": "لماذا تختار OFFPLAN.MARKET؟",
      "Verified Agents & Developers": "وكلاء ومطورون معتمدون",
      "Real-time Market Data": "بيانات السوق الفورية",
      "AI-Powered Matching": "التطابق المدعوم بالذكاء الاصطناعي",
      "Global Investor Support": "دعم المستثمرين العالميين",
      "Our Values": "قيمنا",
      "Transparency & Trust": "الشفافية والثقة",
      "Excellence in Service": "التميز في الخدمة",
      "Client-Centric Approach": "نهج يركز على العميل",
      "Innovation & Growth": "الابتكار والنمو",
      "OFFPLAN.MARKET by the Numbers": "OFFPLAN.MARKET بالأرقام",
      "Our platform has transformed the way investors discover and invest in Dubai's off-plan market": "منصتنا غيرت طريقة اكتشاف المستثمرين للعقارات تحت الإنشاء في دبي",
      "Properties Listed": "العقارات المدرجة",
      "Verified Agents": "وكلاء معتمدون",
      "Developer Partners": "شركاء المطورين",
      "Happy Investors": "مستثمرون سعداء",
      "What Makes Us Different": "ما الذي يجعلنا مختلفين",
      "We combine technology, expertise, and personalized service to deliver exceptional results": "نحن نجمع بين التكنولوجيا والخبرة والخدمة المخصصة لتقديم نتائج استثنائية",
      "Verified Partners": "شركاء معتمدون",
      "All our agents and developers are thoroughly vetted and RERA-registered for your security and peace of mind.": "جميع وكلائنا ومطورينا خضعوا لفحص دقيق ومسجلون في RERA لضمان أمانك وراحة بالك.",
      "Real-Time Data": "البيانات الفورية",
      "Access up-to-the-minute property information, pricing, and availability directly from developer systems.": "احصل على أحدث المعلومات العقارية والأسعار والتوافر مباشرة من أنظمة المطورين.",
      "Smart Matching": "التطابق الذكي",
      "Our AI-powered system matches you with properties that perfectly fit your investment criteria and budget.": "نظامنا المدعوم بالذكاء الاصطناعي يطابقك مع العقارات التي تناسب تمامًا معاييرك الاستثمارية وميزانيتك.",
      "Global Reach": "الوصول العالمي",
      "Serve international investors with multilingual support and comprehensive market insights.": "نخدم المستثمرين الدوليين بدعم متعدد اللغات ورؤى شاملة عن السوق.",
      "End-to-End Support": "دعم متكامل",
      "Complete assistance from property discovery to handover, with ongoing investment guidance.": "مساعدة كاملة من اكتشاف العقار إلى التسليم، مع إرشاد استثماري مستمر.",
      "Exclusive Deals": "عروض حصرية",
      "Access to off-plan opportunities before they hit the general market, with special pricing for our clients.": "الوصول إلى فرص تحت الإنشاء قبل أن تصل إلى السوق العام، مع أسعار خاصة لعملائنا.",
      "Our Expert Team": "فريقنا الخبير",
      "Meet the professionals behind OFFPLAN.MARKET's success": "تعرف على المحترفين وراء نجاح OFFPLAN.MARKET",
      "Real Estate Experts": "خبراء العقارات",
      "Seasoned professionals with deep knowledge of Dubai's property market and investment strategies.": "محترفون متمرسون بخبرة عميقة في سوق العقارات في دبي واستراتيجيات الاستثمار.",
      "Property Consultants": "مستشارو العقارات",
      "Dedicated consultants providing personalized guidance and market insights to help you make informed decisions.": "مستشارون متخصصون يقدمون إرشادات مخصصة ورؤى سوقية لمساعدتك في اتخاذ قرارات مستنيرة.",
      "Customer Success": "نجاح العملاء",
      "Our support team ensures smooth transactions and provides ongoing assistance throughout your investment journey.": "يضمن فريق الدعم لدينا معاملات سلسة ويقدم مساعدة مستمرة طوال رحلتك الاستثمارية.",
      "Ready to Get Started?": "هل أنت مستعد للبدء؟",
      "Join thousands of successful investors who trust OFFPLAN.MARKET for their Dubai real estate journey. Our expert team is ready to guide you to your perfect investment.": "انضم إلى آلاف المستثمرين الناجحين الذين يثقون بـ OFFPLAN.MARKET في رحلتهم العقارية في دبي. فريقنا الخبير جاهز لإرشادك إلى استثمارك المثالي.",
      "Contact Our Team Today": "تواصل مع فريقنا اليوم",

      "Contact Us": "اتصل بنا",
  "Ready to start your Dubai property investment journey?": "هل أنت مستعد لبدء رحلتك في الاستثمار العقاري بدبي؟",
  "Our expert team is here to help you find the perfect off-plan property and guide you through every step": "فريقنا الخبير هنا لمساعدتك في العثور على العقار المثالي على المخطط وإرشادك في كل خطوة",
  "Connect with Our Experts": "تواصل مع خبرائنا",
  "Get In Touch": "ابقى على تواصل",
  "Dubai's Premier Property Platform": "المنصة العقارية الأولى في دبي",
  "Dubai, United Arab Emirates": "دبي، الإمارات العربية المتحدة",
  "Daily 9:00 AM – 9:00 PM (GST)": "يوميًا من 9 صباحًا إلى 9 مساءً (بتوقيت الخليج)",
  "\"Our team will get back to you within 2 hours during business hours.\"": "«سيتواصل فريقنا معك خلال ساعتين أثناء ساعات العمل.»",
  "Quick Contact Options": "خيارات الاتصال السريع",
  "WhatsApp Chat": "دردشة واتساب",
  "Call Now": "اتصل الآن",
  "Send Email": "إرسال بريد إلكتروني",
  "How We Can Help": "كيف يمكننا المساعدة",
  "Property Investment": "الاستثمار العقاري",
  "Expert guidance on off-plan investments": "إرشاد متخصص في الاستثمارات على المخطط",
  "Agent Matching": "توصيل بالوكلاء",
  "Connect with verified real estate agents": "تواصل مع وكلاء عقاريين موثوقين",
  "Market Insights": "رؤى السوق",
  "Latest Dubai real estate market trends": "أحدث اتجاهات سوق العقارات في دبي",
  "Send Us a Message": "أرسل لنا رسالة",
  "Your name": "اسمك",
  "Mobile number": "رقم الجوال",
  "Email address": "عنوان البريد الإلكتروني",
  "Your message": "رسالتك",
  "Your inquiry message": "رسالة استفسارك",
  "I agree to receive updates about new properties and market insights": "أوافق على تلقي التحديثات حول العقارات الجديدة ورؤى السوق",
  "Sending...": "جارٍ الإرسال...",
  "Message Sent!": "تم إرسال الرسالة!",
  "Send Message": "إرسال الرسالة",
  "Ready to Invest?": "هل أنت مستعد للاستثمار؟",
  "Connect with our expert agents for personalized guidance and exclusive property opportunities in Dubai's thriving real estate market.": "تواصل مع وكلائنا الخبراء للحصول على إرشاد شخصي وفرص عقارية حصرية في سوق دبي العقاري المزدهر.",
  "Contact Our Agents Now": "تواصل مع وكلائنا الآن",
