...
const resources = {
  ...
  fa: {
    translation: {
      ...
      "unit_price_payment_plan": "قیمت واحد و برنامه پرداخت",
      "unit_details": "جزئیات واحد",
      "unit_id": "شناسه واحد",
      "status": "وضعیت",
      "size": "متراژ",
      "unit_price": "قیمت واحد",
      "view_all_unit_images_and_renders": "نمایش تمامی تصاویر و رندرهای واحد",
      "view_gallery": "نمایش گالری",
      "floor_plan": "پلان طبقه",
      "download_detailed_floor_plan": "دانلود پلان دقیق طبقه",
      "download_plan": "دانلود پلان",
      "payment_plan": "برنامه پرداخت",
      "flexible_payment_options": "گزینه‌های پرداخت انعطاف‌پذیر",
      "view_details": "مشاهده جزئیات",
      "ready_to_reserve": "آماده رزرو هستید؟",
      "secure_unit_online": "این واحد را هم‌اکنون با یک سپرده کوچک به‌صورت آنلاین رزرو کنید.",
      "reserve_now": "هم‌اکنون رزرو کنید",
      "pay_booking_fee": "پرداخت هزینه رزرو",
      "or": "یا",
      "need_help_or_info": "نیاز به کمک یا اطلاعات بیشتر دارید؟",
      "talk_to_property_advisor": "برای دریافت قیمت، بازدید و راهنمایی با مشاور املاک ما صحبت کنید.",
  ...
  en: {
    translation: {
      ...
      "unit_price_payment_plan": "Unit Price & Payment Plan",
