...
const resources = {
  ...
  ar: {
    translation: {
      ...
      "Amenities": "المرافق",
      "Why Invest in {{name}}": "لماذا تستثمر في {{name}}",
      "Payment Plans": "خطط الدفع",
      "Ready to Make This Your Home?\n\nContact {{name}} today for exclusive access and personalized assistance\n\nCall Now\nChat on WhatsApp": "هل أنت مستعد لجعل هذا منزلك؟\n\nتواصل مع {{name}} اليوم للحصول على وصول حصري ومساعدة شخصية\n\nاتصل الآن\nالدردشة على واتساب",
