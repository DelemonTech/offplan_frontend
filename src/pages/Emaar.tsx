    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: "OffPlan.Market - EMAAR Properties",
          text:"Emaar Properties is Dubai's most valuable and actively traded real estate development company. Since 1997, we have delivered world-class...",
